...
First of all, we have initialized the first MA and FE models, namely FMA and FFE model with all the 12 variables referred above and bias term. The result of logistic regression is:
