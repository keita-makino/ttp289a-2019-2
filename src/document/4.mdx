...
First of all, we have initialized the first MA and FE models, namely FMA and FFE model with all the 12 variables referred above, some common variables such as age group and income level, and bias term. Before feeding the variable into computation, though, we will review the distribution of the variables and make a pre-elimination of the variables.
...
<Bar label={'F8AGEGR' } title={"Figure 4.13. Distribution"} />
<Bar label={'F16INCOM'} title={"Figure 4.14. Distribution"} />
