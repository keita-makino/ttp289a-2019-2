...
First of all, we have initialized the first MA and FE models, namely FMA and FFE model with all the 12 variables referred above and bias term. Before feeding the variable into the computation, though, we will review the distribution of the variable. The following figures illustrates the distribution of each variable with two groups of gender.
