...
In the last, we will develop two new models that have some additional variables or features.  
Those models respectively estimates the working situation (telecommuting or homecommuting) in same group of gender (male or female).
